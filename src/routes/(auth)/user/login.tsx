            ...
            <div class="w-full h-full flex justify-center">
                <div class="bg-[#1F1F1F] w-5/11 h-5/7 flex flex-col justify-center items-center gap-4 stroke-[#686868] rounded-xl border-[#686868] border-1">
                    <div class="flex flex-col gap-10">
                        ...
                        <button class="bg-primary_color_3 text-[#111327] w-70 h-8 rounded-md hover:bg-primary_color_2/100 hover:text-[#111327]/50 transition-colors"
                        onclick={handleLogin}>로그인</button>
                    </div>
                    <div class="flex gap-1">
                        <span class="font-medium text-good_gray">계정이 필요한가요?</span>
                        <A href="/user/signup" class="hover:underline font-bold text-good_gray">회원가입</A>
                    </div>
                </div>
            </div>
        </main>
