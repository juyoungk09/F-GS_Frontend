            ...
            <div class="w-full h-full flex justify-center">
                <div class="bg-[#1F1F1F] w-5/11 h-5/7 flex flex-col justify-center items-center gap-4 stroke-[#686868] rounded-xl border-[#686868] border-1">
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex flex-col gap-1">
                            <div class="font-wanted-sans font-medium">닉네임</div>
                            <input class="p-2 bg-[#2F2F2F] border-[#585858] border-2 rounded-md w-70 h-8" type="text"
                        ...
                        <button class="bg-primary_color_3 w-70 h-8 rounded-md" onclick={handleSignUp}>회원가입</button>
                    </div>
                    <div class="flex gap-1">
                        <span class="font-wanted-sans font-medium">계정이 이미 있나요?</span>
                        <A href="/user/login" class="font-wanted-sans hover:underline font-bold">로그인</A>
                    </div>
                </div>
            </div>
        </main>
