...
const Edit_Password = () => {
    ...
    return(
        <main class="min-h-screen flex flex-col bg-gray-50 gap-10 items-center justify-center">
                    ...
                    <div class="flex flex-col mb-auto gap-6 items-center">
                        <div class="flex flex-col gap-10 items-center">
                            <div class="flex flex-col gap-3">
                                ...
                                <input class="flex-none bg-[#FCFBFC] border border-gray-300 text-xl rounded-xl px-4 w-100 h-12" type="password"
                            ...
                            <div class="flex flex-col gap-5 items-center">
                                <button class="bg-primary_color_3 text-white w-70 h-10 rounded-lg
                                hover:bg-primary_color_2/100 hover:text-white/50 transition-colors" onClick={handlePasswordChange}
                                >비밀번호 변경</button>
